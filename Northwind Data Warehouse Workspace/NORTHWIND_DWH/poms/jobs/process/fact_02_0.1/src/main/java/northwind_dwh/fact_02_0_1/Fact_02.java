...
package northwind_dwh.fact_02_0_1;
 ...
 * @status
 */
public class Fact_02 implements TalendJob {
	...
	private final String jobName = "Fact_02";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Fact_02.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		final static byte[] commonByteArrayLock_NORTHWIND_DWH_Fact_02 = new byte[0];
		static byte[] commonByteArray_NORTHWIND_DWH_Fact_02 = new byte[0];
		...
		public int Total_Delivers;

		public int getTotal_Delivers() {
			return this.Total_Delivers;
		}
		...
		public void copyDataTo(row5Struct other) {
			...
			other.No_Orders = this.No_Orders;
			other.Delivers = this.Delivers;
			other.Total_Delivers = this.Total_Delivers;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NORTHWIND_DWH_Fact_02) {
				...
				try {
					...
					this.No_Orders = dis.readInt();

					this.Delivers = dis.readInt();

					this.Total_Delivers = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.No_Orders);

				// int

				dos.writeInt(this.Delivers);

				// int

				dos.writeInt(this.Total_Delivers);
		...
		public String toString() {
			...
			sb.append(",No_Orders=" + String.valueOf(No_Orders));
			sb.append(",Delivers=" + String.valueOf(Delivers));
			sb.append(",Total_Delivers=" + String.valueOf(Total_Delivers));
			sb.append("]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NORTHWIND_DWH_Fact_02.length) {
					if (length < 1024 && commonByteArray_NORTHWIND_DWH_Fact_02.length == 0) {
						commonByteArray_NORTHWIND_DWH_Fact_02 = new byte[1024];
					} else {
						commonByteArray_NORTHWIND_DWH_Fact_02 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NORTHWIND_DWH_Fact_02, 0, length);
				strReturn = new String(commonByteArray_NORTHWIND_DWH_Fact_02, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NORTHWIND_DWH_Fact_02, 0, length);
				strReturn = new String(commonByteArray_NORTHWIND_DWH_Fact_02, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NORTHWIND_DWH_Fact_02) {
				...
				try {
					...
					this.Shipping_Date = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.Shipping_Date, dos);
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Date_SK", "Employee_SK", "Customer_SK", "No_Orders", "Delivers",
						"Total_Delivers", });
...
///////////////////////    			
				...
				int insertKeyCount_tDBOutput_1 = 3;
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:aw12PqeQT3FsvOE0YWxfl3UBcYPv9Y9yCmcYsg==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "Fact_02";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Fact_02";
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([Date_SK] INT  not null ,[Employee_SK] INT  not null ,[Customer_SK] INT  not null ,[No_Orders] INT  not null ,[Delivers] INT  not null ,[Total_Delivers] INT  not null ,primary key([Date_SK],[Employee_SK],[Customer_SK]))");
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1
								+ "] WHERE [Date_SK] = ? AND [Employee_SK] = ? AND [Customer_SK] = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Date_SK],[Employee_SK],[Customer_SK],[No_Orders],[Delivers],[Total_Delivers]) VALUES (?,?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:sZvnlGVrwUZLGhRFdf8IGmMsQSEWdCaiTFXRoQ==");

				String dbPwd_tDBInput_4 = decryptedPassword_tDBInput_4;

				String port_tDBInput_4 = "1433";
				String dbname_tDBInput_4 = "Northwind_Staging_Area_DB";
				String url_tDBInput_4 = "jdbc:jtds:sqlserver://" + "DESKTOP-CN6NE31";
				if (!"".equals(port_tDBInput_4)) {
					url_tDBInput_4 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_4)) {
					url_tDBInput_4 += "//" + "Northwind_Staging_Area_DB";
				}
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row1.Order_ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row1.Order_ID = tmpContent_tDBInput_4;
								}
							} else {
								row1.Order_ID = null;
							}
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row1.Employee_ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row1.Employee_ID = tmpContent_tDBInput_4;
								}
							} else {
								row1.Employee_ID = null;
							}
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row1.Customer_ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row1.Customer_ID = tmpContent_tDBInput_4;
								}
							} else {
								row1.Customer_ID = null;
							}
						...
						if (colQtyInRs_tDBInput_4 < 4) {
							...
							row1.Order_Date = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 4);

						}
						if (colQtyInRs_tDBInput_4 < 5) {
							row1.Shipping_Date = null;
						} else {

							row1.Shipping_Date = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 5);
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row4HashKey.Customer_ID = row1.Customer_ID;
						...
						if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row4.Customer_ID = '" +
							// row4HashKey.Customer_ID + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							Var.No_Orders = Relational.ISNULL(row1.Shipping_Date) ? 1 : 0;
							Var.Delivers = Relational.ISNULL(row1.Shipping_Date) ? 0 : 1;
							Var.Total_Delivers = Var.No_Orders + Var.Delivers;// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'out1'
								...
								out1_tmp.Employee_SK = row2.Employee_SK;
								out1_tmp.Customer_SK = row4.Customer_SK;
								out1_tmp.No_Orders = Var.No_Orders;
								out1_tmp.Delivers = Var.Delivers;
								out1_tmp.Total_Delivers = Var.Total_Delivers;
								out1 = out1_tmp;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							row5.Date_SK = out1.Date_SK;
							row5.Employee_SK = out1.Employee_SK;
							row5.Customer_SK = out1.Customer_SK;
							row5.No_Orders = out1.No_Orders;
							row5.Delivers = out1.Delivers;
							row5.Total_Delivers = out1.Total_Delivers;
							row6 = new row6Struct();

							row6.Date_SK = out1.Date_SK;
							row6.Employee_SK = out1.Employee_SK;
							row6.Customer_SK = out1.Customer_SK;
							row6.No_Orders = out1.No_Orders;
							row6.Delivers = out1.Delivers;
							row6.Total_Delivers = out1.Total_Delivers;
...
///////////////////////		
							...
							row_tLogRow_1[0] = String.valueOf(row5.Date_SK);

							row_tLogRow_1[1] = String.valueOf(row5.Employee_SK);

							row_tLogRow_1[2] = String.valueOf(row5.Customer_SK);

							row_tLogRow_1[3] = String.valueOf(row5.No_Orders);

							row_tLogRow_1[4] = String.valueOf(row5.Delivers);

							row_tLogRow_1[5] = String.valueOf(row5.Total_Delivers);
...
///////////////////////    			
							...
							pstmt_tDBOutput_1.setInt(1, row6.Date_SK);

							pstmt_tDBOutput_1.setInt(2, row6.Employee_SK);

							pstmt_tDBOutput_1.setInt(3, row6.Customer_SK);
							...
							if (checkCount_tDBOutput_1 < 1) {
								pstmtInsert_tDBOutput_1.setInt(1, row6.Date_SK);

								pstmtInsert_tDBOutput_1.setInt(2, row6.Employee_SK);

								pstmtInsert_tDBOutput_1.setInt(3, row6.Customer_SK);

								pstmtInsert_tDBOutput_1.setInt(4, row6.No_Orders);

								pstmtInsert_tDBOutput_1.setInt(5, row6.Delivers);

								pstmtInsert_tDBOutput_1.setInt(6, row6.Total_Delivers);
...
///////////////////////    			
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row4,row3,row2) outputs:(out1)
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XKkKPfjR5RWAINh2CjbI8/or8DRNZaUTOzFkzA==");

				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;

				String port_tDBInput_1 = "1433";
				String dbname_tDBInput_1 = "Northwind_DWH";
				String url_tDBInput_1 = "jdbc:jtds:sqlserver://" + "DESKTOP-CN6NE31";
				if (!"".equals(port_tDBInput_1)) {
					url_tDBInput_1 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_1)) {
					url_tDBInput_1 += "//" + "Northwind_DWH";
				}
				...
				String dbquery_tDBInput_1 = "SELECT dbo.Dim_Customer.Customer_SK,\n		dbo.Dim_Customer.Customer_ID,\n		dbo.Dim_Customer.Company_Name,\n		dbo.Dim_Custome"
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row4.Customer_SK = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row4.Customer_ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row4.Customer_ID = tmpContent_tDBInput_1;
								}
							} else {
								row4.Customer_ID = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row4.Company_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row4.Company_Name = tmpContent_tDBInput_1;
								}
							} else {
								row4.Company_Name = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row4.Full_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row4.Full_Name = tmpContent_tDBInput_1;
								}
							} else {
								row4.Full_Name = null;
							}
						...
						row4_HashRow.Customer_SK = row4.Customer_SK;

						row4_HashRow.Customer_ID = row4.Customer_ID;

						row4_HashRow.Company_Name = row4.Company_Name;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:AM1n5Xcs3V5mRa7Z9hRpQr4aI0TzNgFg47nk9w==");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String port_tDBInput_2 = "1433";
				String dbname_tDBInput_2 = "Northwind_DWH";
				String url_tDBInput_2 = "jdbc:jtds:sqlserver://" + "DESKTOP-CN6NE31";
				if (!"".equals(port_tDBInput_2)) {
					url_tDBInput_2 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_2)) {
					url_tDBInput_2 += "//" + "Northwind_DWH";
				}
				...
				String dbquery_tDBInput_2 = "SELECT dbo.Dim_Date.Date_SK,\n		dbo.Dim_Date.Date_ID,\n		dbo.Dim_Date.\"Day\",\n		dbo.Dim_Date.\"Month\",\n		dbo.Dim_Date."
						+ "\"Year\"\nFROM	dbo.Dim_Date";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row3.Date_SK = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row3.Date_ID = mssqlGTU_tDBInput_2.getDate(rsmd_tDBInput_2, rs_tDBInput_2, 2);
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row3.Day = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.Day = tmpContent_tDBInput_2;
								}
							} else {
								row3.Day = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row3.Month = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.Month = tmpContent_tDBInput_2;
								}
							} else {
								row3.Month = null;
							}
						...
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row3.Year = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row3.Year = tmpContent_tDBInput_2;
								}
							} else {
								row3.Year = null;
							}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:j5hyUKMkc1mV/aRmmYNdlGCxoubmx008rppW5g==");

				String dbPwd_tDBInput_3 = decryptedPassword_tDBInput_3;

				String port_tDBInput_3 = "1433";
				String dbname_tDBInput_3 = "Northwind_DWH";
				String url_tDBInput_3 = "jdbc:jtds:sqlserver://" + "DESKTOP-CN6NE31";
				if (!"".equals(port_tDBInput_3)) {
					url_tDBInput_3 += ":" + "1433";
				}
				if (!"".equals(dbname_tDBInput_3)) {
					url_tDBInput_3 += "//" + "Northwind_DWH";
				}
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row2.Employee_SK = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row2.Employee_ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row2.Employee_ID = tmpContent_tDBInput_3;
								}
							} else {
								row2.Employee_ID = null;
							}
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							if (tmpContent_tDBInput_3 != null) {
								if (talendToDBList_tDBInput_3.contains(
									...
									row2.Full_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
								} else {
									row2.Full_Name = tmpContent_tDBInput_3;
								}
							} else {
								row2.Full_Name = null;
							}
						...
						row2_HashRow.Employee_SK = row2.Employee_SK;
	...
	public static void main(String[] args) {
		final Fact_02 Fact_02Class = new Fact_02();

		int exitCode = Fact_02Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_02.class.getClassLoader()
					.getResourceAsStream("northwind_dwh/fact_02_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fact_02.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_02");
		}
...
/************************************************************************************************
 * 170761 characters generated by Talend Open Studio for Data Integration on the
 * November 11, 2023 at 5:27:52 PM EET
 ************************************************************************************************/