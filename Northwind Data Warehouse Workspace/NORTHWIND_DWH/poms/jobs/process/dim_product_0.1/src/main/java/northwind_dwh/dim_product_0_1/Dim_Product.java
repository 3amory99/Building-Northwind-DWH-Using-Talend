...
package northwind_dwh.dim_product_0_1;
...
public class Dim_Product implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_NORTHWIND_DWH_Dim_Product = new byte[0];
		static byte[] commonByteArray_NORTHWIND_DWH_Dim_Product = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_NORTHWIND_DWH_Dim_Product.length) {
					if (length < 1024 && commonByteArray_NORTHWIND_DWH_Dim_Product.length == 0) {
						commonByteArray_NORTHWIND_DWH_Dim_Product = new byte[1024];
					} else {
						commonByteArray_NORTHWIND_DWH_Dim_Product = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_NORTHWIND_DWH_Dim_Product, 0, length);
				strReturn = new String(commonByteArray_NORTHWIND_DWH_Dim_Product, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_NORTHWIND_DWH_Dim_Product, 0, length);
				strReturn = new String(commonByteArray_NORTHWIND_DWH_Dim_Product, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_NORTHWIND_DWH_Dim_Product) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Product_SK", "Product_ID", "Product_Name", "Category_Name", });
...
///////////////////////    			
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:NiJBwsAoDpEBh3sgSHdTk1+0Y/kxpro1d5OquQ==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "Dim_Product";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Dim_Product";
				}
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
								+ "]([Product_SK] INT  not null ,[Product_ID] VARCHAR(10)   not null ,[Product_Name] NVARCHAR(50)   not null ,[Category_Name] NVARCHAR(50)   not null ,primary key([Product_SK]))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [Product_SK] = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Product_SK],[Product_ID],[Product_Name],[Category_Name]) VALUES (?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:pHx/ORfPzCuZFPc/jPPepqDAEfJsLcBIAPhZXQ==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.Product_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.Product_Name = tmpContent_tDBInput_1;
								}
							} else {
								row1.Product_Name = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.Category_Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.Category_Name = tmpContent_tDBInput_1;
								}
							} else {
								row1.Category_Name = null;
							}
						...
						{ // start of Var scope
							...
							Var.Product_SK = Numeric.sequence("s1", 1, 1);// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'out1'
							out1_tmp.Product_SK = Var.Product_SK;
							out1_tmp.Product_ID = row1.Product_ID;
							out1_tmp.Product_Name = row1.Product_Name;
							out1_tmp.Category_Name = row1.Category_Name;
							out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
						if (out1 != null) {
							...
							row2.Product_SK = out1.Product_SK;
							row2.Product_ID = out1.Product_ID;
							row2.Product_Name = out1.Product_Name;
							row2.Category_Name = out1.Category_Name;
							row3 = new row3Struct();

							row3.Product_SK = out1.Product_SK;
							row3.Product_ID = out1.Product_ID;
							row3.Product_Name = out1.Product_Name;
							row3.Category_Name = out1.Category_Name;
...
///////////////////////		
							...
							row_tLogRow_1[0] = String.valueOf(row2.Product_SK);

							if (row2.Product_ID != null) { //
								row_tLogRow_1[1] = String.valueOf(row2.Product_ID);

							} //

							if (row2.Product_Name != null) { //
								row_tLogRow_1[2] = String.valueOf(row2.Product_Name);

							} //

							if (row2.Category_Name != null) { //
								row_tLogRow_1[3] = String.valueOf(row2.Category_Name);
...
///////////////////////    			
							...
							pstmt_tDBOutput_1.setInt(1, row3.Product_SK);
							...
							if (checkCount_tDBOutput_1 < 1) {
								pstmtInsert_tDBOutput_1.setInt(1, row3.Product_SK);

								if (row3.Product_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, row3.Product_ID);
								}
								...
								if (row3.Product_Name == null) {
									...
									if ("MSSQL_PROP".equals(driver)) {
										pstmtInsert_tDBOutput_1.setNString(3, row3.Product_Name);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, row3.Product_Name);
									}
								}
								...
								if (row3.Category_Name == null) {
									...
									driver = "JTDS";
									if ("MSSQL_PROP".equals(driver)) {
										pstmtInsert_tDBOutput_1.setNString(4, row3.Category_Name);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, row3.Category_Name);
									}
								}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Product.class.getClassLoader()
					.getResourceAsStream("northwind_dwh/dim_product_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 87948 characters generated by Talend Open Studio for Data Integration on the
 * November 11, 2023 at 1:01:16 AM EET
 ************************************************************************************************/